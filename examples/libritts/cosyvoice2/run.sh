...
data_dir=/scratch/s6029388/CosyVoice/ESD_split
pretrained_model_dir=/scratch/s6029388/CosyVoice/CosyVoice2-0.5B
...
if [ ${stage} -le 2 ] && [ ${stop_stage} -ge 2 ]; then
  ...
  for x in train test; do
    tools/extract_speech_token.py --dir data/$x \
      --onnx_path /scratch/s6029388/CosyVoice/pretrained_models/CosyVoice2-0.5B/speech_tokenizer_v2.onnx
  done
fi
