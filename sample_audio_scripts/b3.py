...
# ========== 参数配置（来自问卷表格） ==========
output_wav = "roleB_calm_01.wav"
text_input = "虽然没怎么聊天，但我一直都在想你。"
speaker_id = "0008"
prompt_path = "/scratch/s6029388/CosyVoice/ESD_split/test/0008/Neutral/0008_000045.wav"
system_prompt = (
...
messages = [
    ...
    {"role": "user", "content": f"你是一位别扭热情的男朋友，简短自然地回复女生这句话。\n\n女生说：{text_input}"}
]
