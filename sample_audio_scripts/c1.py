...
output_wav = "roleA_mismatch_01.wav"
text_input = "你猜我今天见到谁了？我居然在街上遇到了我高中同学！"
speaker_id = "0006"
prompt_path = "/scratch/s6029388/CosyVoice/ESD_split/test/0006/Neutral/0006_000009.wav"  # mismatch: calm prompt
system_prompt = (
...
messages = [
    ...
    {"role": "user", "content": f"你是一位冷峻守礼的男朋友，请你用“开心”的语气，简短自然地回复女生这句话。\n\n女生说：{text_input}"}
]
